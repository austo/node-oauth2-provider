...
oap.on('authorize_form', function (req, res, client_id, authorize_url) {
...
oap.on('save_grant', function (req, client_id, code, next) {
...
oap.on('remove_grant', function (user_id, client_id, code) {
  console.log(code);
...
oap.on('lookup_grant', function (client_id, client_secret, code, next) {
...
oap.on('create_access_token', function (user_id, client_id, next) {
...
oap.on('save_access_token', function (
  user_id, client_id, access_token) {
  console.log(
    'saving access token %s for user_id=%s client_id=%s',
    JSON.stringify(access_token), user_id, client_id);
});

// an access token was received in a URL query string parameter or HTTP header
oap.on('access_token', function (req, token, next) {
...
oap.on('client_auth', function (
  client_id, client_secret, username, password, next) {
...
app.get('/login', function (req, res) {
  ...
  res.end('<html><form method="post" action="/login">' +
...
app.get('/secret', function (req, res) {
  if (req.session.user) {
    res.end('proceed to secret lair, extra data: ' +
