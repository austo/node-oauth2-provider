 ...
 * OAuth 2.0 provider
 *
 * based on code originally authored by Amir Malik
 */
'use strict';
...
Provider.prototype.generateAccessToken = function (
...
Provider.prototype.getAuthorization = function (req, res) {
  var self = this;
...
Provider.prototype.postAccessToken = function (req, res) {
  var self = this,
...
Provider.prototype.postAuthorization = function (req, res) {
  var self = this;
