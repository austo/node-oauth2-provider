...
describe('Provider', function () {
  ...
  describe('login', function () {
    ...
    it('should return function that emits access_token event ' +
      'with parsed user data if token can be parsed from request',
      function () {
        // SETUP
    ...
    it('should write error to response if cannot parse access token',
      function () {
        // SETUP
